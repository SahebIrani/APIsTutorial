    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           ;
            ...
            {
                options.ReportApiVersions = true;
                options.Conventions.Controller<Simple.V1.Controllers.TodoItemsController>().HasApiVersion(1, 0);
                options.Conventions.Controller<Simple.V2.Controllers.TodoItemsController>().HasApiVersion(2, 0);
            });
        }
