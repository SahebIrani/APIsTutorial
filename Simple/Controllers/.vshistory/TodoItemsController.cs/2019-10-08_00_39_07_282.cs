...
namespace Simple.Controllers
{
    ...
    public class TodoItemsController : ControllerBase
    {
        ...
        [HttpGet]
        public async ActionResult<IAsyncEnumerable<TodoItem>> Get(long id, CancellationToken cancellationToken = default)
        {
            var todoItems = Context.TodoItems.AsNoTracking().AsAsyncEnumerable();
            return todoItems;
        }
