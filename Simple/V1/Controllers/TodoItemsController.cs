...
namespace Simple.V1.Controllers
{
    ...
    public class TodoItemsController : ControllerBase
    {
        ...
        public async Task<ActionResult<TodoItem>> PostTodoItem(TodoItem todoItem, CancellationToken ct = default)
        {
            ...
            return CreatedAtAction(/*"GetById"*/nameof(GetById), new {/* version = "1"*/ version = HttpContext.GetRequestedApiVersion().ToString(), controller = "TodoItems", id = todoItem.Id }, todoItem);
            //return CreatedAtRoute("GetById", new { id = todoItem.Id }, todoItem);
            //return Created($"https://localhost:5001/v1/TodoItems/{todoItem.Id}", todoItem);
        }


        // GET ~/api/v1/GetApiVersion
        // GET ~/api/GetApiVersion?api-version=1.0
